            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex flex-wrap -mx-3 mb-4">
                <div className="w-full px-3">
                  ...
                  <input id="email" type="text" className="form-input w-full text-gray-800" placeholder="Enter your email address" value={email} onChange={(e) => setEmail(e.target.value)} required />
                </div>
              </div>
              <div className="flex flex-wrap -mx-3 mb-4">
                <div className="w-full px-3">
